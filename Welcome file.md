...
<p><input type="checkbox" class="task-list-item-checkbox" disabled=""> List item</p>
</li>
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" disabled=""> oihůlhlk</p>
</li>
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" disabled=""> kljglkjglkg</p>
<p>if(){<br>
}<br>
|k;lk jlksj; s;ldkg;g| gfhdf |dfghdfgh|<br>
|--------------------|–|<br>
|                    |  |</p>
</li>
</ul>
